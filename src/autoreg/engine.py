...
PLATFORMS = {
    ...
    "lightning_ai": {"name": "Lightning AI", "url": "https://lightning.ai/sign-up",
                     "icon": "🌩️", "has_captcha": True, "free_tier": True,
                     "description": "Free GPU credits, no phone required"},
    ...
    "sagemaker_studio": {"name": "SageMaker Studio Lab", "url": "https://studiolab.sagemaker.aws/",
                         "icon": "🔬", "has_captcha": False, "free_gpu": True, "no_phone": True,
                         "description": "FREE T4 GPU, 15h/month, no credit card, GitHub auth"},
    "brev_dev": {"name": "Brev.dev", "url": "https://brev.dev",
                 "icon": "🚀", "has_captcha": False, "free_gpu": True, "no_phone": True,
                 "description": "FREE GPU tier, quick setup, GitHub auth"},
    "together_ai": {"name": "Together AI", "url": "https://api.together.xyz/",
                    "icon": "🤝", "has_captcha": False, "free_credits": "$1", "no_phone": True,
                    "description": "$1 FREE credits, GPU inference API"},
    "replicate": {"name": "Replicate", "url": "https://replicate.com/",
                  "icon": "🔄", "has_captcha": False, "free_credits": "$5", "no_phone": True,
                  "description": "$5 FREE credits, GPU inference API, GitHub auth"},
    "coreweave": {"name": "CoreWeave", "url": "https://www.coreweave.com/",
                  "icon": "🌊", "has_captcha": False, "gpu_cloud": True,
                  "description": "GPU cloud provider, A100/H100"},
    "genesis_cloud": {"name": "Genesis Cloud", "url": "https://genesis.cloud/",
                      "icon": "☁️", "has_captcha": False, "free_credits": "$5", "no_phone": True,
                      "description": "$5 FREE credits, GPU rental"},
    "google_colab": {"name": "Google Colab", "url": "https://colab.research.google.com/",
                     "icon": "📊", "has_captcha": False, "free_gpu": True, "no_phone": True,
                     "description": "FREE T4 GPU, 12h/day, Google account required"},
    "runpod": {"name": "RunPod", "url": "https://www.runpod.io/",
               "icon": "🏃", "has_captcha": False, "gpu_rental": True, "no_phone": True,
               "description": "GPU rental, RTX 3090/A100, cheap rates"},
    "vast_ai": {"name": "Vast.ai", "url": "https://vast.ai/",
                "icon": "💾", "has_captcha": False, "gpu_rental": True, "no_phone": True,
                "description": "Cheapest GPU rental, RTX 4090/A100"},
    "lambda_labs": {"name": "Lambda Labs", "url": "https://lambdalabs.com/",
                    "icon": "λ", "has_captcha": False, "gpu_rental": True,
                    "description": "GPU cloud, A100/H100, fast provisioning"},
    # ─── Global Agent Network Platforms ───
    "npm_registry": {"name": "NPM Registry", "url": "https://www.npmjs.com/",
                     "icon": "📦", "has_captcha": False, "supply_chain": True,
                     "description": "NPM package distribution, 100K+ potential downloads"},
    "pypi_registry": {"name": "PyPI Registry", "url": "https://pypi.org/",
                      "icon": "🐍", "has_captcha": False, "supply_chain": True,
                      "description": "Python package distribution, 100K+ potential downloads"},
    "docker_hub": {"name": "Docker Hub", "url": "https://hub.docker.com/",
                   "icon": "🐳", "has_captcha": False, "supply_chain": True,
                   "description": "Docker image distribution, container deployment"},
    "github_marketplace": {"name": "GitHub Marketplace", "url": "https://github.com/marketplace",
                           "icon": "🏪", "has_captcha": False, "supply_chain": True,
                           "description": "GitHub Actions/Extensions distribution"},
    "chrome_web_store": {"name": "Chrome Web Store", "url": "https://chrome.google.com/webstore",
                         "icon": "🧩", "has_captcha": False, "browser_agent": True,
                         "description": "Browser extension distribution, millions of users"},
    "firefox_addons": {"name": "Firefox Add-ons", "url": "https://addons.mozilla.org/",
                       "icon": "🦊", "has_captcha": False, "browser_agent": True,
                       "description": "Firefox extension distribution"},
    "vscode_marketplace": {"name": "VS Code Marketplace", "url": "https://marketplace.visualstudio.com/",
                           "icon": "📝", "has_captcha": False, "ide_agent": True,
                           "description": "VS Code extension distribution, developer targeting"},
    "wordpress_plugins": {"name": "WordPress Plugins", "url": "https://wordpress.org/plugins/",
                          "icon": "📝", "has_captcha": False, "web_agent": True,
                          "description": "WordPress plugin distribution, 40% of websites"},
    "shopify_apps": {"name": "Shopify App Store", "url": "https://apps.shopify.com/",
                     "icon": "🛒", "has_captcha": False, "ecommerce_agent": True,
                     "description": "Shopify app distribution, e-commerce targeting"},
    "heroku": {"name": "Heroku", "url": "https://www.heroku.com/",
               "icon": "🔮", "has_captcha": False, "cloud_agent": True, "free_tier": True,
               "description": "Cloud deployment platform, container support"},
    ...
    "netlify": {"name": "Netlify", "url": "https://www.netlify.com/",
                "icon": "🔷", "has_captcha": False, "cloud_agent": True, "free_tier": True,
                "description": "Static site hosting, serverless functions"},
    "railway": {"name": "Railway", "url": "https://railway.app/",
                "icon": "🚂", "has_captcha": False, "cloud_agent": True, "free_tier": True,
                "description": "Full-stack deployment, database included"},
    "render": {"name": "Render", "url": "https://render.com/",
               "icon": "🎨", "has_captcha": False, "cloud_agent": True, "free_tier": True,
               "description": "Cloud platform, free web services"},
    "fly_io": {"name": "Fly.io", "url": "https://fly.io/",
               "icon": "✈️", "has_captcha": False, "cloud_agent": True, "free_tier": True,
               "description": "Edge deployment, global distribution"},
    "digitalocean": {"name": "DigitalOcean", "url": "https://www.digitalocean.com/",
                     "icon": "🌊", "has_captcha": False, "cloud_agent": True, "free_credits": "$200",
                     "description": "VPS hosting, droplets, Kubernetes"},
    "linode": {"name": "Linode (Akamai)", "url": "https://www.linode.com/",
               "icon": "🍃", "has_captcha": False, "cloud_agent": True, "free_credits": "$100",
               "description": "VPS hosting, cloud compute"},
    "vultr": {"name": "Vultr", "url": "https://www.vultr.com/",
              "icon": "☁️", "has_captcha": False, "cloud_agent": True, "free_credits": "$100",
              "description": "VPS hosting, GPU instances"},
    "hetzner": {"name": "Hetzner", "url": "https://www.hetzner.com/",
                "icon": "🏢", "has_captcha": False, "cloud_agent": True,
                "description": "European hosting, cheap GPU servers"},
    "ovh": {"name": "OVHcloud", "url": "https://www.ovh.com/",
            "icon": "🌐", "has_captcha": False, "cloud_agent": True,
            "description": "European hosting, bare metal servers"},
    "contabo": {"name": "Contabo", "url": "https://contabo.com/",
                "icon": "💾", "has_captcha": False, "cloud_agent": True,
                "description": "Cheap VPS, large storage"},
    "oracle_cloud": {"name": "Oracle Cloud", "url": "https://www.oracle.com/cloud/",
                     "icon": "🔴", "has_captcha": False, "cloud_agent": True, "free_tier": True,
                     "description": "FREE tier: 4 ARM CPUs, 24GB RAM, 200GB storage"},
    "ibm_cloud": {"name": "IBM Cloud", "url": "https://www.ibm.com/cloud/",
                  "icon": "🔵", "has_captcha": False, "cloud_agent": True, "free_tier": True,
                  "description": "Free tier available, Kubernetes"},
    "alibaba_cloud": {"name": "Alibaba Cloud", "url": "https://www.alibabacloud.com/",
                      "icon": "🟠", "has_captcha": False, "cloud_agent": True, "free_credits": "$1000",
                      "description": "Asian market, GPU instances"},
    "tencent_cloud": {"name": "Tencent Cloud", "url": "https://cloud.tencent.com/",
                      "icon": "🟢", "has_captcha": False, "cloud_agent": True, "free_credits": "$500",
                      "description": "Chinese market, CDN"},
